...
class tektronixfrTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.fr1=hvlfilereader.tektronixfr('testfiles/tektronix_DPO2012B/T0001CH1.CSV')
        pass
    ...
    def test_tekfr_T0001CH1(self):
        ...
        self.assertAlmostEqual(self.fr1.samplerate, 1.6e-07,delta=(self.fr1.samplerate/1.0e7)) # Have to compute delta!
